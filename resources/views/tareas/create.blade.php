        ...
        <div class="col-md-8">
            <div class="showTarea">
                <div class="card-header">
                    <h3 class="card-title"> {{ __('Nueva Tarea') }} </h3>
                </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('tareas.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="fechainicio" type="date" class="form-control @error('fechainicio') is-invalid @enderror" name="fechainicio" required autocomplete="fechainicio" onchange="minfechafin(this)">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="fechavencimiento" type="date" min="" class="form-control @error('fechavencimiento') is-invalid @enderror" name="fechavencimiento" required autocomplete="fechavencimiento">
